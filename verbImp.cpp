...
//private
string Verb::validTypes[4] = {"ar", "er", "ir", "��r"};
...
Verb::ConjRules Verb::endings = {
  .present = {
    ...
    .er = {"o", "es", "e", "emos", "en"},
    .ir = {"o", "es", "e", "imos", "en"},
    .Ir = {"o", "es", "e", "��mos", "en"}//I think this one is correct, might not be though
  },
  .preterite = {
    .ar = {"�", "aste", "�", "amos", "aron"},
    .erir = {"��", "iste", "i�", "imos", "ieron"},
    .Ir = {"�", "��ste", "i�", "�mos", "ieron"},//also not 100% sure on this one
    .stemChange = {"e", "iste", "o", "imos", "ieron"},
    .stemChangeJ = {"e", "iste", "o", "imos", "eron"},
    .endingChange = {"", "", "y�", "", "yeron"}// so only can be used on proper forms
  }
};
...
void Verb::setPreteriteSpellChanges(){
  ...
  }else if((ending3 == "eer") || (ending3 == "oer") || (ending3 == "o��r") || (ending3 == "uir") || (getEnding(4) == "caer")){
